...
func (n *Node) processRollCall(ctx context.Context, from peer.ID, req request.RollCall) error {
	...
	metrics.IncrCounterWithLabels([]string{"b7s", "rollcalls", "seen"}, 1, []metrics.Label{{Name: "function", Value: req.FunctionID}})
	...
	metrics.IncrCounterWithLabels([]string{"b7s", "rollcalls", "applied"}, 1, []metrics.Label{{Name: "function", Value: req.FunctionID}})
...
func (n *Node) publishRollCall(ctx context.Context, requestID string, functionID string, consensus consensus.Type, topic string, attributes *execute.Attributes) error {
	...
	metrics.IncrCounterWithLabels([]string{"b7s", "rollcalls", "published"}, 1, []metrics.Label{{Name: "function", Value: functionID}})
